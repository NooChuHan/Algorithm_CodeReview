...
// 고민한 부분
// 0부터 citations의 최댓값까지 하나씩 증가하는 수인 h와 citations 배열의 요소를 비교하며 h 보다 큰 수를 찾고 그것을 count라는 변수에 할당했다. 이때 h와 count가 같은 경우만 한다면 모든 테스트케이스를 통과하지 못한다.
// 그래서 count가 h보다 큰 경우중에 가장 두 수의 차이가 작은 경우를 반환해주어야하는데 이것을 구현하기위해 좀 고민을 했다.
// h를 citations의 최댓값부터 하나씩 감소시키면서 count가 h보다 큰 경우중에 가장 차이가 작은 경우를 확인했다.
